...
public class AnadoluBolgesiDeparHatlariAdapter extends BaseAdapter {
    ArrayList<AnadoluBolgesiDeparHatlariModel> anadoluBolgesiDeparHatlari;
    LayoutInflater layoutInflater;
    Context context;

    public AnadoluBolgesiDeparHatlariAdapter(Activity activity, ArrayList<AnadoluBolgesiDeparHatlariModel> anadoluBolgesiDeparHatlari){
